...
extern "C" bool    OSSpinLockTry( volatile OSSpinLock *__lock );
extern "C" void    OSSpinLockLock( volatile OSSpinLock *__lock );
extern "C" void    OSSpinLockUnlock( volatile OSSpinLock *__lock );
/* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * */
...
//    FBASSERTGATED(from);
    ...
    {
        if (0 == __private->hibernateGammaDataLen)
        {
